...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[UINavigationBar appearance] setBackgroundImage:img(@"bg_navigationBar_normal") forBarMetrics:0];
//    [[UINavigationBar appearance] setTintColor:[UIColor whiteColor]];
    ...
    [MobClick startWithAppkey:@"565951bee0f55ac24900a04c" reportPolicy:REALTIME channelId:@"91"];
    return YES;
}
