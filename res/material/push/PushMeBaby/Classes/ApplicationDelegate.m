...
- (id)init {
	self = [super init];
	if(self != nil) {
		self.deviceToken = @"74eabab5 6e652e66 17c4d829 b8f75381 30fb869c 490305eb 409218a5 32713150";
		self.payload = @"{\"aps\":{\"category\" : \"NEW_MESSAGE_CATEGORY\",\"alert\":\"pushmessagecontent\",\"badge\":1}}";
