$(function() {
    ...
    if ($('script[src="http://cdn.cocimg.com/assets/js/jquery.colorbox-min.js?v=20150818"]').length <= 1) {
        var colorbox_js = document.createElement('script'); colorbox_js.type = 'text/javascript'; colorbox_js.async = true;
        colorbox_js.src = ('https:' == document.location.protocol ? 'https://' : 'http://') + 'cdn.cocimg.com/assets/js/jquery.colorbox-min.js?v=20150818';
        var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(colorbox_js, s);
    }
